<aside class="fixed inset-y-0 left-0 z-40 w-64 bg-gradient-to-b from-slate-900 via-slate-900 to-brand-green-darker text-slate-100 hidden lg:flex lg:flex-col shadow-xl">
    ...
    <nav class="flex-1 px-3 py-5 space-y-0.5 overflow-y-auto">
        ...
        <a href="{{ route('admin.reports.logins') }}" class="{{ request()->routeIs('admin.reports.logins') ? 'admin-sidebar-link-active' : 'admin-sidebar-link-inactive' }}">
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/></svg>
            Login Report
        </a>
        <a href="{{ route('admin.reports.activity') }}" class="{{ request()->routeIs('admin.reports.activity', 'admin.reports.activity.show') ? 'admin-sidebar-link-active' : 'admin-sidebar-link-inactive' }}">
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
            Activity Log
        </a>
        <a href="{{ route('admin.reports.sessions') }}" class="{{ request()->routeIs('admin.reports.sessions') ? 'admin-sidebar-link-active' : 'admin-sidebar-link-inactive' }}">
        ...
        <a href="{{ route('admin.reports.teacher-subjects') }}" class="{{ request()->routeIs('admin.reports.teacher-subjects') ? 'admin-sidebar-link-active' : 'admin-sidebar-link-inactive' }}">
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
            Teacher Subjects
        </a>
        <a href="{{ route('admin.reports.chapter-list') }}" class="{{ request()->routeIs('admin.reports.chapter-list') ? 'admin-sidebar-link-active' : 'admin-sidebar-link-inactive' }}">
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
            Chapter List
        </a>
        <a href="{{ route('admin.reports.logout-reports') }}" class="{{ request()->routeIs('admin.reports.logout-reports', 'admin.reports.logout-reports.show') ? 'admin-sidebar-link-active' : 'admin-sidebar-link-inactive' }}">
        ...
        <a href="{{ route('admin.tickets.index') }}" class="{{ request()->routeIs('admin.tickets.*') ? 'admin-sidebar-link-active' : 'admin-sidebar-link-inactive' }}">
