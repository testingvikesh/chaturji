<x-email-layout title="Ticket generated" eyebrow="Ticket generated">
    <p style="margin:0 0 12px;font-size:16px;">Hello {{ $ticket->user?->name ?? 'there' }},</p>
    <p style="margin:0 0 16px;font-size:14px;line-height:1.6;color:#334155;">
        Your support ticket has been generated. Save this ticket number.
    </p>
