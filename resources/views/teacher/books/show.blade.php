<x-teacher-layout>
    ...
    <div class="admin-page">
        <div class="mb-4">
            <a href="{{ route('teacher.books.index', ['medium' => $medium]) }}" class="text-sm text-brand-green hover:underline font-medium">&larr; Back to Books</a>
        </div>
        ...
        <div class="admin-card">
            ...
            @include('partials.book-index-materials', [
                'materials' => $materials,
                'subject' => $subject,
                'materialTopicRoute' => 'teacher.books.topics.show',
                'materialChapterRoute' => 'teacher.books.materials.show',
