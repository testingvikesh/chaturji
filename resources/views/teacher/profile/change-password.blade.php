<x-teacher-layout>
    ...
    <div class="admin-page max-w-2xl">
        ...
        <div class="admin-form-card">
            ...
            <form method="POST" action="{{ route('teacher.password.update') }}" class="admin-card-body space-y-5">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-wrap items-center gap-3 pt-2">
                    ...
                    <a href="{{ route('teacher.profile.edit') }}" class="admin-btn-secondary">Edit Profile</a>
