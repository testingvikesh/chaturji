<x-guest-layout>
    <div class="mb-6">
        ...
        <p class="text-sm text-slate-500 mt-1">Register for admin back panel access</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.register') }}">
        ...
        <div class="flex items-center justify-between mt-6">
            <a class="text-sm text-brand-green hover:text-brand-green-dark font-medium" href="{{ route('admin.login') }}">
